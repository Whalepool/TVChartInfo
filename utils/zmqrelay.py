import coloredlogs, logging, time, json, pprint, zmq 
...
class ZmqRelay(  ):
    ...
    def __init__(self, topic, server=False, ZMQ_PUBLISH_TO_PORT=5557, ZMQ_RECEIVE_FROM_TO_PORT=5558 ):
        ...
        self.sender.connect('tcp://127.0.0.1:5557')
